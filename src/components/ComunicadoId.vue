    ...
    <div class="container">
      <div class="section-bredcumbs">
        <h5>
          ...
          <b> > </b>  
          <router-link style="text-decoration: none" to="/comunicados">
            <b>Comunicados Publicadas</b>
          </router-link>
          <b> > </b>
          <router-link style="text-decoration: none" to="#">
            <b v-if="lista">Comunicado Nº.{{ lista.num_doc }} - {{ lista.titulo }}</b>
          </router-link>
      ...
      <div v-if="lista">
        <div class="section-title">
          <h2>Comunicado Nº.{{ lista.num_doc }} - {{ lista.titulo }}</h2>
        </div>
        <p></p>
        <div class="post-img">
...
export default {
  ...
  mounted() {
    ...
    fetch(`${API_ENDPOINT}/api/comunicado/`+ this.$route.params.id) 
